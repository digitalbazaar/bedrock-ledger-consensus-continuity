...
api.getHistory = ({
  ...
  console.log('777777777777777', creatorId);
  console.log('GETHISTORYTREEHASH', treeHash);
  async.auto({
    ...
    // FIXME: move this query into the aggregate $match
    ...
    aggregate: ['firstDescendant', (results, callback) => {
      ...
      logger.debug('L186 getHistory, start aggregate.');
