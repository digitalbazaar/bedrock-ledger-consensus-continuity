...
api.getHeads = callbackify(async ({eventHashes, ledgerNode}) => {
  ...
  if(notFound.length > 0) {
    ...
    // audit:continuity/0d6b6dfe-f507-4b64-883c-667e886c5e01.md
    // this does use an index, but is not covered, but that seems OK since
    // this sits behind the cache
