...
async function _getMergeableHashes({ledgerNode}) {
  ...
  // FIXME: need to ensure that any childlessHashes weren't already merged...
  // this could potentially be solved by recomputing `childlessHashes` at the
  // start of every work session (potential danger is a merge happened but
  // then the childless hash cache wasn't updated for any reason)
