...
exports.wrapKeyPair = async ({ledgerNodeId, peerId}) => {
  const localPeer = await _localPeers.getKeyPair({ledgerNodeId, peerId});
...
exports.sign = async ({event, ledgerNodeId}) => {
  const key = await exports.wrapKeyPair({ledgerNodeId});
