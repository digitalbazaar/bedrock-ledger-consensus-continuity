...
api.write = async ({worker, consensusResult}) => {
  ...
  // FIXME: update `consensusResult` to include list of newly detected forkers
  // ... update all events for each one with the new
  // `meta.continuity2017.forkDetectedBlockHeight`
