...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.post(routes.gossipCompressed, (req, res, next) => {
    ...
    async.auto({
      ...
      readStream.end(results.history);
      res.set('Content-disposition', 'attachment; filename=events.gz');
