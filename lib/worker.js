...
function _firstRoundVote(ledgerNode, voter, blockId, callback) {
  ...
  // TODO: increment round and vote again; if no previous vote, then
  //   create a manifest out of all non-deleted, non-consensus event hashes
  //   (make a helper method to get this) ... if a previous vote exists,
  //   then run instant run off mechanism to determine the next manifest to
  //   vote for ... implement this in a helper method. This instant runoff
