...
// prevents an event with an advanced blockHeight from causing gossip delays
// this should be set relative to gossip.maxDepth. Default is maxDepth * 1.5.
cfg.gossip.blockHeightThreshold = 9;
