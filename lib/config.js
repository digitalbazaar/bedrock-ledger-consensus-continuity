...
cfg.events.maxOperations = 250;

cfg.merge = {};
// calculate a debounce based on the number of outstanding merge events
cfg.merge.calculateDebounce = false;
// if calculate is false, use a fixed debounce (ms)
cfg.merge.fixedDebounce = 1500;
