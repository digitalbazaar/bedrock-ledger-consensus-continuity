...
cfg.routes = {};
cfg.routes.base = '/consensus/continuity2017';
cfg.routes.root = cfg.routes.base + '/voters/:voterId';
cfg.routes.eventsQuery = cfg.routes.root + '/events-query';
cfg.routes.eventValidation = cfg.routes.base + '/validation/events';
cfg.routes.gossip = cfg.routes.root + '/gossip';
cfg.routes.operationValidation = cfg.routes.base + '/validation/operations';
...
// options for event validation service
const eventValidation = cfg.gossip.eventValidation = {};
// the max timeout to validate a single operation
eventValidation.timeout = 5000;
// the base url for the event validation service
eventValidation.baseUrl = '';
// the https agent options to be used with the event validation service
eventValidation.httpsAgentOpts = undefined;
// the max number of events a given process will validate concurrently
eventValidation.concurrency = 10;
// FIXME: this value is dynamic and represents the active number of workers
//        validating events
eventValidation.workers = 10;

// options for operation validation service
const operationValidation = cfg.gossip.operationValidation = {};
// the max timeout to validate a single operation
operationValidation.timeout = 5000;
// the base url for the operation validation service
operationValidation.baseUrl = '';
// the https agent options to be used with the operation validation service
operationValidation.httpsAgentOpts = undefined;
// the max number of operations a given process will validate concurrently
operationValidation.concurrency = 10;
// FIXME: this value is dynamic and represents the active number of workers
//        validating operations
operationValidation.workers = 10;
