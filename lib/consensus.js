 ...
 *              consensus.
 */
api.findConsensus = ({ledgerNodeId, history, blockHeight, electors}) => {
 ...
 */
function _findMergeEventProof({ledgerNodeId, tails, blockHeight, electors}) {
  let startTime = Date.now();
...
function _tallyBranches({ledgerNodeId, yByElector, blockHeight, electors}) {
  /* Algorithm:
...
function _tally({ledgerNodeId, event, yByElector, blockHeight, electors}) {
