...
function _getAncestorHashes({allXs, ledgerNodeId}) {
  ...
  // compute base consensus sort hash
  ...
  order.sort((a, b) => {
    ...
    if(!a._consensusSortHash) {
      a._consensusSortHash = _sha256(baseHash + a.eventHash);
    }
    if(!b._consensusSortHash) {
      b._consensusSortHash = _sha256(baseHash + b.eventHash);
    }
    return a._consensusSortHash.localeCompare(b._consensusSortHash);
  });
  ...
  */
  ...
  if(preCommit && preCommit._endorsed) {
    ...
    */
    ...
    // TODO: require precommits to be endorsed to achieve BFT?
