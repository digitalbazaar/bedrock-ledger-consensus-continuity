        ...
        if(!event._yDescendants) {
          ...
          for(const elector of electorSet) {
            ...
            for(const y of yByElector[elector]) {
              // TODO: possible optimization would be to do a diff between
              //   descendants before and descendants after -- and only
              //   process the new descendants when updating recent votes
