...
async function _checkParentHashCommitments({
  ...
  // FIXME: build nonWitnessHashes to check for commitments
  // FIXME: witnesses will need to be retrieved for every merge event's
  // `basisBlockHeight` -- gather these first and get the witnesses in a
  // single call -- or rely on some caching to handle it properly
  const nonWitnessHashes = [];

  // FIXME: check database for commitments
