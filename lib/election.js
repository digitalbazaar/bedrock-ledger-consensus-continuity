...
api._compareVotes = _compareVotes;
...
function _tally(
  ...
  tally.sort((a, b) => {
    ...
    return api._compareVotes({event, a, b});
  });
...
/**
 * Compares two votes, each with `{count, set}` in the context of a particular
 * voting event. Exposed for testing purposes.
 *
 ...
 */
function _compareVotes({event, a, b}) {
