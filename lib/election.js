 ...
 */
api.getLocalBranchHead = (ledgerNode, electors, callback) => {
  ...
  //   `callback` for `api.getLocalBranchHead`
};
...
api.findConsensus = (ledgerNode, history, callback) => {
  ...
  // TODO: _getLocalBranchHead(..., (err, history) => { ...
 ...
 * approved by a consensus of electors.
 *
