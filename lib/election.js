...
api._compareEventSets = _compareEventSets;
...
function _tally(
  ...
  tally.sort((a, b) => {
    ...
    return api._compareEventSets({event, a, b});
  });
...
/**
 * Compares two sets of events in the context of a particular event. Exposed
 * for testing purposes.
 *
 * @param event the event that provides context.
 * @param a the first set of events.
 * @param b the second set of events.
 *
 * @return true if a < b, false otherwise.
 */
function _compareEventSets({event, a, b}) {
