...
async function _prepareNextMerge({
  ...
  halt, nonEmptyEventWitnessParentThreshold, emptyEventWitnessParentThreshold
}) {
  const ledgerNodeId = ledgerNode.id;
  ...
  */
  ...
  // FIXME: ensure this cannot cause consensus not to be reached
  ...
  // FIXME: check `peerChildlessHashes` for those from witnesses
  //nonEmptyEventWitnessParentThreshold, emptyEventWitnessParentThreshold
