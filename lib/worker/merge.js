...
async function _prepareNextMerge({
  ...
  computed the required parent hashes.*/
  ...
  /* Compute how many additional remaining parent slots there are so we can add
  a potential non-witness parent and operation events can be created and merged
  to flush out the operation queue (provided that
  `lastLocalContributorConsensus` is `true`). */
