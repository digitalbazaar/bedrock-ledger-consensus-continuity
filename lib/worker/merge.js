...
async function _prepareNextMerge({
  ...
  // we always leave one extra slot available to merge in a non-witness
  // peer's merge event, this is what the `-1` is for
  let remainingSlots = maxEvents - parentHashes.size - 1;
