...
exports.sendNotification = async ({
  ...
  // FIXME: change this to send notifications in parallel
...
async function _gw({worker, peer}) {
  ...
  // FIXME: add sample peers; update peers.addNotifier() to split out function
  // for adding peers and call it
  ...
  await peer.success({mergeEventsReceived, backoff, cursor});
  return {mergeEventsReceived, cursor};
}
