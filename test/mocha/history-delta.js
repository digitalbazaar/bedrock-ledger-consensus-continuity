...
module.exports = (api, consensusApi, eventTemplate, nodes) => ({
  ...
  cpb: ['regularEvent', (results, callback) => api.copyAndMerge({
    consensusApi,
    from: [nodes.gamma, nodes.epsilon],
    to: nodes.delta
  }, callback)],
  ...
  ss7: ['cp24', (results, callback) => api.snapshotEvents(
    {ledgerNode: nodes.delta}, callback)],
  cp25: ['ss7', 'cp24', (results, callback) => api.copyAndMerge({
    consensusApi,
    from: nodes.delta,
    to: nodes.epsilon
  }, callback)],
  cp26: ['cp23', (results, callback) => api.copyAndMerge({
    consensusApi,
    from: nodes.alpha,
    to: nodes.beta
  }, callback)],
  cp27: ['ss7', (results, callback) => api.copyAndMerge({
    consensusApi,
    from: nodes.delta,
    to: nodes.gamma,
    useSnapshot: true
