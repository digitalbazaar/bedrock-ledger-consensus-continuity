...
module.exports = ({api, consensusApi, eventTemplate, nodes, opTemplate}) => ({
  ...
  // snapshot gamma before copy
  ss4: ['cp11', 'cp12', (results, callback) => callbackify(api.snapshotEvents)(
    {ledgerNode: nodes.gamma}, callback)],
  ...
  cp15: ['cp14', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: 'beta',
    nodes,
    to: 'delta'
  }, callback)],
  cp16: ['cp15', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: ['beta', 'delta'],
    nodes,
    to: 'alpha'
  ...
  cp20: ['ss18', 'ss19', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: ['alpha', 'delta'],
    nodes,
    to: 'gamma',
  ...
  ss20: ['cp20', (results, callback) => callbackify(api.snapshotEvents)(
    {ledgerNode: nodes.gamma}, callback)],
  cp21: ['ss20', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: 'gamma',
    nodes,
    to: 'beta',
  ...
  // snapshot beta before copy
  ss21: ['cp21', (results, callback) => callbackify(api.snapshotEvents)(
    {ledgerNode: nodes.beta}, callback)],
  cp22: ['ss20', 'ss21', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: ['beta', 'gamma'],
    nodes,
    to: 'alpha',
  ...
  cp23: ['ss20', 'ss21', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: ['beta', 'gamma'],
    nodes,
    to: 'delta',
  ...
  cp24: ['cp23', (results, callback) => callbackify(api.copyAndMerge)({
    consensusApi,
    from: 'delta',
    nodes,
    to: 'gamma'
